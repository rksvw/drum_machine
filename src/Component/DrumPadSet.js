...
function DrumPadSet({
  ...
  return (
    ...
    >
      ...
      >
        <p style={{ font: "normal bolder normal 14px/1 FontAwesome" }}>FCC</p>
        <svg
          stroke="currentColor"
          fill="currentColor"
          stroke-width="0"
        ...
        >
          <div
            ...
            style={{
              ...
              left: isPowerOn ? "60px" : "5px", // 👈 left/right toggle
              width: "35px",
              height: "35px",
              backgroundColor: isPowerOn ? "white" : "gray",
              borderRadius: "50%",
      ...
      <div className="change_audio"></div>
    </div>
  );
}
